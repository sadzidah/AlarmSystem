...
void MainWindow::placeWidgets()
{
    ...
    menu->addAction("Add user", this, &MainWindow::onInsert);
    menu->addAction("Remove user", this, &MainWindow::onDelete);
    menu->addAction("See last activity", this, &MainWindow::onDelete);
